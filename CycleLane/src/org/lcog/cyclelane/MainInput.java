...
public class MainInput extends Activity {
    ...
    private void buildAlertMessageNoGps() {
        ...
        builder.setMessage("Your phone's GPS is disabled. CycleLane needs GPS to determine your location.\n\nGo to System Settings now to enable GPS?")
               .setCancelable(false)
    ...
    private void showWelcomeDialog() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Please enter your personal details so we can learn a bit about you.\n\nThen, try to use CycleLane every time you ride. Your trip routes will be sent to the LCOG so we can plan for better biking!\n\nThanks,\nThe LCOG CycleLane team")
               .setCancelable(false).setTitle("Welcome to CycleLane!")
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case MENU_HELP:
        	Intent myIntent = new Intent(Intent.ACTION_VIEW,
        			Uri.parse("http://www.thempo.org/learn/androidhelp.cfm"));
